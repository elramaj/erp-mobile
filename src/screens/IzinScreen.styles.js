...
export default StyleSheet.create({
  ...
  izinJenisRow: { flexDirection: "row", alignItems: "center", gap: 6 },
  ...
  attachItemTypeRow: { flexDirection: "row", alignItems: "center", gap: 4 },
  ...
  infoText: { flex: 1, fontSize: 12, color: "#15803d", lineHeight: 18 },
  btnSubmit: {
    backgroundColor: "#dc2626",
    borderRadius: 12,
    padding: 16,
